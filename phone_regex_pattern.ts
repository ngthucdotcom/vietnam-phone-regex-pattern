 ...
 * - Group 3: ((1800|1900)+([0-9]{4,6})\b)
 * => PBX phone in Vietnam
 * Source: https://vi.wikipedia.org/wiki/Mã_điện_thoại_Việt_Nam
 */
export const phoneRegexPattern: string = '((03+([2-9]{1})|05+([2]{1}|[5-6]{1}|[8-9]{1})|07+([0]{1}|[6-9]{1})|08+([1-9]{1})|09+([0-9]{1}))+([0-9]{7})\\b)|(02+([0-9]{9})\\b)|((1800|1900)+([0-9]{4,6})\\b)';
